...
b = Pleureuse.new(pseudo:Faker::Name.first_name(), gender:["Male","Female"].sample(1).join, city:["Nantes","Paris","Marseille","Rennes","Nancy"].sample(1).join, description:Faker::GreekPhilosophers.quote,price:rand(10..100),language:(["Italian","German","French","Spanish"].sample(1).join),user_id: a.id, picture: pictures[u])
u += 1
